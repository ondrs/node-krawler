 ...
 * @const
 */
Krawler.prototype.VERSION = '0.2.3';
...
Krawler.prototype.fetchUrl = function(url) {
  ...
  if(!opts.headers['Accept'] && !opts.headers['accept']) {
    ...
    switch (self.options_.parser) {
      case 'xml':
        opts.headers['Accept'] = 'application/xml, text/xml;q=0.9, */*;q=0.8';
        break;
      case 'json':
        opts.headers['Accept'] = 'application/json, application/javascript;q=0.8, */*;q=0.8';
        break;
      default :
        opts.headers['Accept'] = 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8';
      break;
    }
  }
